...
export class Backend implements backendInterface {
    ...
    async getMonthlySnapshots(): Promise<Array<MonthlySnapshot>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthlySnapshots();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveMonthlySnapshot(arg0: MonthlySnapshot): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMonthlySnapshot(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePortfolio(arg0: Portfolio): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePortfolio(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
